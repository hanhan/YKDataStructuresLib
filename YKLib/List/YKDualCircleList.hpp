//
//  YKDualCircleList.hpp
//  YKLib
//
//  Copyright © 2017年 nethanhan. All rights reserved.
//

#ifndef YKDualCircleList_hpp
#define YKDualCircleList_hpp

#include "YKCircleList.hpp"
#include "LinuxList.h"

namespace YKLib
{
    template <typename T>
    class YKDualCircleList: public YKCircleList<T>
    {
    protected:
    ...
    public:
        ...
        bool insert(int i, const T& e)
        {
            ...
            {
                THROW_EXCEPTION(YKNoEnoughMemoryException, "no memory to insert new element ...");
            }
        ...
        T get(int i) const
        {
            ...
            {
                THROW_EXCEPTION(YKIndexOutOfBoundsException, "invalid parameter i to get element ...");
            }
        ...
        int find(const T& e) const
        {
            ...
            {
                if (list_entry(slider, Node, head))
                {
                    ret = i;
                    break;
                }
